        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationSent = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Colognes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Colognes_Items_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaseDiameter = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CaseThickness = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BandMaterial = table.Column<string>(type: "nvarchar(max)", nullable: false),
